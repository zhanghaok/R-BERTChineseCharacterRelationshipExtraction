...
default_pretrained_model_path = '/home/zhk/pretrained-model/bert-base-chinese'
default_train_file = '/home/zhk/data/RE/train_small.jsonl'
default_validation_file = '/home/zhk/data/RE/val_small.jsonl'
default_output_dir = os.path.join(here, 'saved_models')
default_log_dir = os.path.join(default_output_dir, 'log')
default_tagset_file = os.path.join(here, '/home/zhk/data/RE/relation.txt')
